...
plt.legend()
plt.axhline(y=0.2265971031730966, color='r', linestyle='--', linewidth=1)
plt.axhline(y=0.24490450115379334, color='r', linestyle='--', linewidth=1)
plt.axhline(y=0.24905537083629034, color='r', linestyle='--', linewidth=1)
plt.axhline(y=0.25, color='m', linestyle='--', linewidth=1)
plt.savefig('Average Return for each n.png', bbox_inches='tight')
